...
const ChatArea = ({ onClose }) => {
  ...
  return (
    <main className="h-screen flex">
      ...
      <section className="w-[400px] flex flex-col justify-between h-full shadow-lg backdrop-blur-lg bg-neutral-900/60">
        <header className="flex justify-between items-center bg-neutral-800/50 h-16 px-1">
          <div className="flex items-center">
            <button
              className="p-2 rounded-full hover:bg-neutral-800/70 transition"
              onClick={onClose}
            >
              <MdOutlineKeyboardArrowLeft className="text-white/80 text-3xl" />
            </button>
            <button
              className="p-2 rounded-full hover:bg-neutral-800/70 transition"
          ...
          <button
            className="p-3 rounded-full hover:bg-neutral-800/70 transition items-center flex justify-center"
            onClick={() => setIsAddCollaboratorOpen(true)}
          >
            <IoPersonAddSharp className="text-emerald-300 text-2xl" />
          </button>
        </header>
