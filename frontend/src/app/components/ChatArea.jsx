...
const ChatArea = ({ onClose }) => {
  ...
  return (
    ...
    <section
  className="w-[400px] mb-2 mx-2 mt-11 rounded-2xl border border-neutral-700 flex flex-col justify-between  shadow-lg backdrop-blur-lg bg-neutral-950 overflow-hidden"
>
